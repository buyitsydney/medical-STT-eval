#!/bin/bash
# 渐进式 Speechmatics Medical Domain 评测脚本
# 每次运行增加 5 个新文件，不会重复！
# 使用 domain: "medical" 进行医疗领域专业转写
...
TRANSCRIPT_DIR="results/transcripts/speechmatics-enhanced-medical"
...
echo "============================================================"
echo "🏥 Speechmatics Medical Domain 渐进式评测"
echo "============================================================"
echo "   模型: speechmatics-enhanced-medical"
echo "   配置: operating_point=enhanced, domain=medical"
echo ""
...
if [ "$TODO_COUNT" -eq 0 ]; then
    ...
    echo ""
    echo "运行以下命令更新指标:"
    echo "   python3 evaluate/metrics_generator.py --model_name speechmatics-enhanced-medical"
...
# 6. 逐个转写（使用 medical domain）
echo ""
echo "============================================================"
echo "🎤 开始转写 (Medical Domain)..."
echo "============================================================"
...
echo "📊 更新指标..."
echo "============================================================"
python3 evaluate/metrics_generator.py --model_name speechmatics-enhanced-medical
...
echo ""
echo "💡 继续评测请再次运行: bash run_batch_eval_medical.sh"
